...
<?php 
	...
	echo "\t\t\t".'<a type="button" class="btn btn-default" href="<?=Url::to(["'.str_replace('_','-',$idName).'/index"])?>">Hủy</a>'."\n";
	echo "\t\t\t".'<a type="button" class="btn <?= $model->isNewRecord ? "btn-success" : "btn-info" ?>" id="btn_save" >Lưu</a>'."\n";
	echo "\t\t".'</div>'."\n";
	echo "\t".'</div>'."\n";
	echo "</form>\n";
?>